...
<html lang="fr" data-bs-theme="auto">
  <head>
    ...
    <title>Administration - Corail</title>
...
<main class="form-signin w-100 m-auto">
  <form method="post">
    <img class="mb-4 rounded-circle shadow" src="/public/assets/img/logo-big.png" alt="" width="112" height="97" style="object-fit: cover;">
    ...
    <div class="my-2">Pas encore de compte ? <a href="signin.php">Enregistrez vous</a></div>   
