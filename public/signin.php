...
<main class="form-signin w-100 m-auto">
  <form method="post">
    <img class="mb-4 rounded-circle shadow" src="assets/img/logo-big.png" alt="" width="112" height="97" style="object-fit: cover;">
    ...
    <div class="form-floating">
      <input name="email" type="email" class="form-control" id="floatingInput" placeholder="nom@example.com">
    ...
    <div class="form-floating">
      <input name="retype_password" type="password" class="form-control" id="floatingPassword" placeholder="Confirmation">
      <label for="floatingPassword">Confirmation</label>
    </div>
    <div class="my-2">Déjà enregistré ? <a href="login.php">Connectez vous</a></div>
